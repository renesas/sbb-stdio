...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                            (0x007807E7UL)  // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_ADC_D_IS_ADC12                                      (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_FLASH_PREFETCH_BUFFER                               (1UL)           // Indicates the prefetch buffer is available on the flash.
...
#define BSP_FEATURE_GPT_AD_CONVERSION_START_CHANNEL_MASK                (0x00UL)        // Mask of GPT channels supporting A/D conversion start.
...
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK                        (0x03F1UL)      // Mask of channels that support event count input (has GTUPSR register).
...
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK                              (0x03F1UL)      // Mask of channels that support dead time control.
#define BSP_FEATURE_GPT_GTDVU_SUPPORTED                                 (1UL)           // At least one GPT channel with GTDVU support is available.
#define BSP_FEATURE_GPT_MSTP_HAS_MSTPCRE                                (0UL)           // Indicates the MSTP peripheral has an MSTPCRE register.
#define BSP_FEATURE_GPT_MSTP_MSTPD5                                     (1UL)           // GPT stop bits use MSTPCRD.MSTPD5.
...
#define BSP_FEATURE_GPT_POLARITY_CONTROL_SUPPORTED                      (0UL)           // At least one GPT channel supports polarity inversion of the GTIOCnA or GTIOCnB I/O pins.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                      (0xF30F00FFULL) // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_IIC_VALID_CHANNEL_MASK                              (0x01UL)        // Mask of available IIC channels.
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                                   (0x730200FFULL) // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_RTC_HAS_ROPSEL                                      (1UL)           // The RCR4.ROPSEL field is available.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK                     (0x0207UL)      // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS_MASK                                   (0x0207UL)      // Mask of available SCI channels.
#define BSP_FEATURE_SCI_CLOCK                                           (FSP_PRIV_CLOCK_PCLKB)  // Clock source routed to the SCI peripherals.
#define BSP_FEATURE_SCI_HAS_CLOCK                                       (0UL)           // Indicates there is a separate SCI clock.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS_MASK                               (0x00UL)        // Mask of channels that can support LIN.
#define BSP_FEATURE_SCI_SPI_SCKSEL_MASK                                 (0UL)           // Mask indicating CCR4.SCKSEL is available.
...
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS_MASK                       (0x00UL)        // Mask of channels which support CTS external pins.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS_MASK                         (0x01UL)        // Mask of channels which support the UART FIFO.
...
#define BSP_FEATURE_SPI_BURST_TRANSFER_WITHOUT_DELAY_SUPPORTED          (0UL)           // Burst transfer without delay between frames is supported.
#define BSP_FEATURE_SPI_CLOCK                                           (FSP_PRIV_CLOCK_PCLKB)  // Clock source for SPI peripherals.
#define BSP_FEATURE_SPI_HAS_CLOCK                                       (0UL)           // Indicates there is a separate clock for the SPI.
...
#define BSP_FEATURE_SPI_NUM_CHANNELS                                    (1UL)           // Number of available SPI channels.
