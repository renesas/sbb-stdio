...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = {
    
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_ANALOG_ENABLE | (uint32_t) IOPORT_CFG_DRIVE_MID)
    },
    ...
    
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_IRQ_ENABLE | (uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT)
    },
    ...
    
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT)
    },
    
    {
        .pin = BSP_IO_PORT_04_PIN_08,
        .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_IRQ_ENABLE | (uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT | (uint32_t) IOPORT_CFG_PULLUP_ENABLE)
    },
