...
#define BSP_PERIPHERAL_ACMPHS_CHANNEL_MASK       (0x3U)
...
#define BSP_PERIPHERAL_GPT_CHANNEL_MASK          (0x3C3FU)
...
#define BSP_PERIPHERAL_OSPI_B_CHANNEL_MASK       (0x1U)
...
#define BSP_PERIPHERAL_PORT_CHANNEL_MASK         (0x3FFU)
...
#define BSP_PERIPHERAL_SCI_B_CHANNEL_MASK        (0x21FU)
