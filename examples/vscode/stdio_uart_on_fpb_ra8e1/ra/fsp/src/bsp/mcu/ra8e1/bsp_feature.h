...
#define BSP_FEATURE_ADC_HAS_SAMPLE_HOLD_REG                             (1UL)           // Specifies configuration for the sample and hold circuit is available (specifically ADSHCR register).
...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                            (0x01F7UL)      // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS_MASK                            (0x7FUL)        // Mask of available channels in ADC unit 1.
...
#define BSP_FEATURE_BSP_NUM_PMSAR                                       (10UL)          // Number of available Port Security Attribution Registers.
...
#define BSP_FEATURE_BSP_UNIQUE_ID_POINTER                               (0x03008190UL)  // Address of the MCU Unique ID register (UIDR).
...
#define BSP_FEATURE_CGC_PLL2_OUT_MIN_HZ                                 (40000000UL)    // Minimum output frequency for PLL unit 2.
#define BSP_FEATURE_CGC_PLLCCR_TYPE                                     (3UL)           // Indicates the type of PLLCCR register and PLL.
#define BSP_FEATURE_CGC_PLLCCR_VCO_MAX_HZ                               (1440000000UL)  // PLL VCO maximum frequency.
...
#define BSP_FEATURE_DMAC_HAS_DELSR                                      (1UL)           // DELSRn registers are available in the DMA peripheral block.
...
#define BSP_FEATURE_ETHER_NUM_CHANNELS                                  (1UL)           // Number of available ethernet PHYs.
...
#define BSP_FEATURE_FLASH_USER_LOCKABLE_AREA_SIZE                       (712UL)         // Size of the user lockable areas (non-OFS registers).
#define BSP_FEATURE_FLASH_USER_LOCKABLE_AREA_START                      (0x27030098UL)  // Start address of the first non-OFS lockable word by LK_CD_A0.

#define BSP_FEATURE_FLASH_HP_IS_AVAILABLE                               (1UL)
#define BSP_FEATURE_FLASH_HP_CF_DUAL_BANK_START                         (0x02200000UL)  // Start of the second code flash bank.
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                              (0x3FUL)        // Mask of 32-bit GPT channel indices.
#define BSP_FEATURE_GPT_AD_CONVERSION_START_CHANNEL_MASK                (0x3FUL)        // Mask of GPT channels supporting A/D conversion start.
#define BSP_FEATURE_GPT_AD_DIRECT_START_SUPPORTED                       (1UL)           // GPT A/D conversion start request is directly output to ADC instead of via the ELC.
...
#define BSP_FEATURE_GPT_OPS_CHANNEL_MASK                                (0x00UL)        // Mask of channels supporting output phase switching.
#define BSP_FEATURE_GPT_OPS_SUPPORTED                                   (0UL)           // At least one GPT channel with OPS support is available.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                      (0x00007708FB1DFFFFULL) // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_DPSIER_MASK                                     (0xAD1FFFFFULL) // Mask of valid bit-fields of the DPSIERn registers.
...
#define BSP_FEATURE_LPM_HAS_DPSBYCR_SRKEEP                              (1UL)           // The DPSBYCR.SRKEEP field is available.
...
#define BSP_FEATURE_LVD_MONITOR_1_STABILIZATION_TIME_US                 (20UL)          // Maximum stabilization time to wait after LVD1 is enabled.
...
#define BSP_FEATURE_LVD_MONITOR_2_STABILIZATION_TIME_US                 (20UL)          // Maximum stabilization time to wait after LVD2 is enabled.
...
#define BSP_FEATURE_SCI_CHANNELS_MASK                                   (0x021FUL)      // Mask of available SCI channels.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS_MASK                               (0x03UL)        // Mask of channels that can support LIN.
...
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS_MASK                       (0x021FUL)      // Mask of channels which support CTS external pins.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS_MASK                         (0x021FUL)      // Mask of channels which support the UART FIFO.
...
#define BSP_FEATURE_SYSC_CLOCK_FREQ_NO_RAM_WAITS                        (120000000UL)   // The maximum frequency that can be used before wait cycles are necessary.
