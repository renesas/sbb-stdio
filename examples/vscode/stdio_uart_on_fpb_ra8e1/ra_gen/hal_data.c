...
#include "hal_data.h"
sci_b_uart_instance_ctrl_t     g_uart_jlob_vcom_ctrl;

            sci_b_baud_setting_t               g_uart_jlob_vcom_baud_setting =
            {
            ...
            const sci_b_uart_extended_cfg_t g_uart_jlob_vcom_cfg_extend =
            {
