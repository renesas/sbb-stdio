...
#include "bsp_mcu_device_pn_cfg.h"
            ...
            #include "../../../ra/fsp/src/bsp/mcu/ra8e1/bsp_override.h"
            #include "../../../ra/fsp/src/bsp/mcu/ra8e1/bsp_mcu_info.h"
...
#define BSP_TZ_CFG_DPFSAR ((RA_NOT_DEFINED > 0) ? 0U : 0xAD1FFFFFU)
#endif
            /* RAM Standby Control Security Attribution Register. */
#ifndef BSP_TZ_CFG_RSCSAR
#define BSP_TZ_CFG_RSCSAR ((RA_NOT_DEFINED > 0) ? 0U : 0x0001007FU)
#endif
...
#define BSP_TZ_CFG_CGFSAR (0x00670BFDU)
#endif
#endif
...
#define BSP_TZ_CFG_ICUSARE ((RA_NOT_DEFINED > 0) ? 0U : 0xFB1D0000U)
#endif

            /* Security attribution registers for WUPEN1. */
#ifndef BSP_TZ_CFG_ICUSARF
#define BSP_TZ_CFG_ICUSARF ((RA_NOT_DEFINED > 0) ? 0U : 0x00007708U)
#endif
