...
/*******************************************************************************************************************//**
 * @ingroup BOARD_RA0L1_FPB
 * @defgroup BOARD_RA0L1_FPB_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the FPB board. It includes info on the number of LEDs and which pins they are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RA0L1_FPB_LEDS) */
