...
#define BSP_PERIPHERAL_ADC_D_PRESENT             (1)
#define BSP_PERIPHERAL_ADC_D_CHANNEL_MASK        (0x1U)
#define BSP_PERIPHERAL_AGT_PRESENT               (0)
#define BSP_PERIPHERAL_AGT_CHANNEL_MASK          (0x0U)
...
#define BSP_PERIPHERAL_CAC_PRESENT               (0)
...
#define BSP_PERIPHERAL_DMA_DMAC_CHANNEL_MASK     (0x0U)
#define BSP_PERIPHERAL_DOC_PRESENT               (0)
...
#define BSP_PERIPHERAL_GPT_PRESENT               (0)
#define BSP_PERIPHERAL_GPT_CHANNEL_MASK          (0x0U)
...
#define BSP_PERIPHERAL_GPT_OPS_PRESENT           (0)
#define BSP_PERIPHERAL_GPT_POEG_PRESENT          (0)
#define BSP_PERIPHERAL_GPT_POEG_CHANNEL_MASK     (0x0U)
...
#define BSP_PERIPHERAL_ICU_EXT_IRQ_CHANNEL_MASK  (0xFFU)
...
#define BSP_PERIPHERAL_IICA_PRESENT              (1)
#define BSP_PERIPHERAL_IICA_CHANNEL_MASK         (0x3U)
...
#define BSP_PERIPHERAL_MPU_PRESENT               (0)
#define BSP_PERIPHERAL_MPU_CHANNEL_MASK          (0x0U)
...
#define BSP_PERIPHERAL_PCLBUZ_PRESENT            (1)
...
#define BSP_PERIPHERAL_PORGA_PRESENT             (1)
#define BSP_PERIPHERAL_PORT_PRESENT              (1)
#define BSP_PERIPHERAL_PORT_CHANNEL_MASK         (0x23FU)
...
#define BSP_PERIPHERAL_RTC_C_PRESENT             (1)
#define BSP_PERIPHERAL_SAU_PRESENT               (1)
#define BSP_PERIPHERAL_SAU_CHANNEL_MASK          (0x3U)
#define BSP_PERIPHERAL_SAU_I2C_PRESENT           (1)
#define BSP_PERIPHERAL_SAU_I2C_CHANNEL_MASK      (0x300030003U)
#define BSP_PERIPHERAL_SAU_SPI_PRESENT           (1)
#define BSP_PERIPHERAL_SAU_SPI_CHANNEL_MASK      (0x100030003U)
#define BSP_PERIPHERAL_SAU_UART_PRESENT          (1)
#define BSP_PERIPHERAL_SAU_UART_CHANNEL_MASK     (0x7U)
...
#define BSP_PERIPHERAL_TAU_PRESENT               (1)
#define BSP_PERIPHERAL_TAU_CHANNEL_MASK          (0xFFU)
#define BSP_PERIPHERAL_TFU_PRESENT               (0)
#define BSP_PERIPHERAL_TML_PRESENT               (1)
#define BSP_PERIPHERAL_TML_CHANNEL_MASK          (0x1U)
...
#define BSP_PERIPHERAL_UARTA_PRESENT             (1)
#define BSP_PERIPHERAL_UARTA_CHANNEL_MASK        (0x3U)
#define BSP_PERIPHERAL_UARTA_CK_PRESENT          (1)
#define BSP_PERIPHERAL_UARTA_CK_CHANNEL_MASK     (0x1U)
...
#define BSP_PERIPHERAL_WDT_PRESENT               (0)
#define BSP_PERIPHERAL_WDT_CHANNEL_MASK          (0x0U)
