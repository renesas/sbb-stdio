...
/*******************************************************************************************************************//**
 * @addtogroup BSP_MCU_RA0L1
 * @{
 **********************************************************************************************************************/

/** @} (end addtogroup BSP_MCU_RA0L1) */
...
#define BSP_OVERRIDE_LPM_SNOOZE_CANCEL_SOURCES_T
...
typedef enum e_ioport_peripheral
{
    ...
    IOPORT_PERIPHERAL_UARTA7     = (0x07UL << IOPORT_PRV_PSEL_OFFSET),
    ...
    IOPORT_PERIPHERAL_UARTA7_OUT = ((0x07UL << IOPORT_PRV_PSEL_OFFSET) | IOPORT_PERIPHERAL_PIN_OUT),
    IOPORT_PERIPHERAL_IICA1      = (0x01UL << IOPORT_PRV_PSEL_OFFSET),
    IOPORT_PERIPHERAL_IICA3      = (0x03UL << IOPORT_PRV_PSEL_OFFSET),
    IOPORT_PERIPHERAL_IICA4      = (0x04UL << IOPORT_PRV_PSEL_OFFSET),
    IOPORT_PERIPHERAL_IICA5      = (0x05UL << IOPORT_PRV_PSEL_OFFSET),
    IOPORT_PERIPHERAL_IICA6      = (0x06UL << IOPORT_PRV_PSEL_OFFSET),
    ...
    IOPORT_PERIPHERAL_CTSU       = (0x0CUL << IOPORT_PRV_PSEL_OFFSET),
} ioport_peripheral_t;
...
typedef enum e_lpm_standby_wake_source
{
    ...
    LPM_STANDBY_WAKE_SOURCE_IRQ6       = 0x00000100ULL,     ///< IRQ6
    LPM_STANDBY_WAKE_SOURCE_IRQ7       = 0x00000200ULL,     ///< IRQ7
    LPM_STANDBY_WAKE_SOURCE_IICA0      = 0x04000000ULL,     ///< IICA0 interrupt
    ...
    LPM_STANDBY_WAKE_SOURCE_IICA1      = 0x40000000000ULL,  ///< IICA1 interrupt
    LPM_STANDBY_WAKE_SOURCE_UARTA1ERRI = 0x80000000000ULL,  ///< UARTA1 reception communication error interrupt
    LPM_STANDBY_WAKE_SOURCE_UARTA1TXI  = 0x100000000000ULL, ///< UARTA1 transmission transfer end or buffer empty interrupt
    LPM_STANDBY_WAKE_SOURCE_UARTA1RXI  = 0x200000000000ULL, ///< UARTA1 reception transfer end interrupt
...
typedef enum e_lpm_snooze_cancel_source
{
    ...
    LPM_SNOOZE_CANCEL_SOURCE_CTSU_CTSUFN      = 0x1000000000000ULL, ///< CTSU Measurement End Interrupt
...
typedef enum e_adc_channel
{
    ...
    ADC_CHANNEL_5                  = 5,   ///< Channel 5 for select mode or channel 5 to 8 for scan mode
    ADC_CHANNEL_6                  = 6,   ///< Channel 6 for select mode or channel 6 to 9 for scan mode
    ADC_CHANNEL_7                  = 7,   ///< Channel 7 for select mode or channel 7 to 10 for scan mode
    ADC_CHANNEL_8                  = 8,   ///< Channel 8 for select mode or channel 8 to 11 for scan mode
    ADC_CHANNEL_9                  = 9,   ///< Channel 9 for select mode or channel 9 to 12 for scan mode
    ADC_CHANNEL_10                 = 10,  ///< Channel 10 for select mode
    ADC_CHANNEL_TSCAP_VOLT         = 16,  ///< CTSU TSCAP voltage for select mode
