 ...
 * */
typedef enum e_elc_event_ra0l1
{
    ...
    ELC_EVENT_SAU0_SPI_TXRXI01              = (0x011), // SAU UART RX 0/I2C 01/SPI 01
    ELC_EVENT_SAU0_IIC_TXRXI01              = (0x011), // SAU UART RX 0/I2C 01/SPI 01
    ...
    ELC_EVENT_ICU_IRQ6                      = (0x01B), // External pin interrupt 6
    ELC_EVENT_ICU_IRQ7                      = (0x01C), // External pin interrupt 7
    ELC_EVENT_UARTA1_ERRI                   = (0x01D), // UARTA1 reception communication error occurrence
    ELC_EVENT_UARTA1_TXI                    = (0x01E), // UARTA1 transmission transfer end or buffer empty interrupt
    ELC_EVENT_UARTA1_RXI                    = (0x01F), // UARTA1 reception transfer end
    ELC_EVENT_IICA1_TXRXI                   = (0x020)  // End of IICA1 communication
} elc_event_t;

/** Fixed vector enumeration
 * @note This list is device specific.
 * */
typedef enum e_icu_event_ra0l1
{
    ...
    ICU_EVENT_ICU_IRQ6                      = (8), // External pin interrupt 6
    ICU_EVENT_ICU_IRQ7                      = (9), // External pin interrupt 7
    ...
    ICU_EVENT_SAU1_IIC_TXRXI21              = (13), // SAU UART RX 2/I2C 21/SPI 21
    ...
    ICU_EVENT_SAU0_SPI_TXRXI10              = (22), // SAU UART TX 1/I2C 10/SPI 10
    ICU_EVENT_SAU0_IIC_TXRXI10              = (22), // SAU UART TX 1/I2C 10/SPI 10
    ...
    ICU_EVENT_SAU0_SPI_TXRXI01              = (27), // SAU UART RX 0/I2C 01/SPI 01
    ICU_EVENT_SAU0_IIC_TXRXI01              = (27), // SAU UART RX 0/I2C 01/SPI 01
    ...
    ICU_EVENT_IICA1_TXRXI                   = (42), // End of IICA1 communication
    ICU_EVENT_UARTA1_ERRI                   = (43), // UARTA1 reception communication error occurrence
    ICU_EVENT_UARTA1_TXI                    = (44), // UARTA1 transmission transfer end or buffer empty interrupt
    ICU_EVENT_UARTA1_RXI                    = (45), // UARTA1 reception transfer end
    ICU_EVENT_CTSU_WRITE                    = (46), // Write request interrupt
    ICU_EVENT_CTSU_READ                     = (47), // Measurement data transfer request interrupt
    ICU_EVENT_CTSU_END                      = (48)  // Measurement end interrupt
} icu_event_t;
...
#define BSP_ELC_PERIPHERAL_MASK  (0x1F840000U)
