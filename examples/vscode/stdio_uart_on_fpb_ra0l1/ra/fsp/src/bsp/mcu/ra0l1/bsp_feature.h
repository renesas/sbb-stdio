...
#define BSP_FEATURE_ACMPHS_VREF                                         (ACMPHS_REFERENCE_NONE) // Feature not available on this device.
...
#define BSP_FEATURE_ADC_CLOCK_SOURCE                                    (FSP_PRIV_CLOCK_PCLKB)  // Clock source used for the ADC peripheral.
...
#define BSP_FEATURE_ADC_HAS_CLOCK                                       (0UL)           // Indicates there is a separate clock for the ADC.
...
#define BSP_FEATURE_ADC_B_UNIT_0_CHANNELS_MASK                          (0x00ULL)       // Feature not available on this device.
#define BSP_FEATURE_ADC_B_UNIT_1_CHANNELS_MASK                          (0x00ULL)       // Feature not available on this device.

#define BSP_FEATURE_ADC_D_IS_AVAILABLE                                  (1UL)
#define BSP_FEATURE_ADC_D_CHANNELS_MASK                                 (0x006107FFUL)  // Mask of available channels.
#define BSP_FEATURE_ADC_D_IS_ADC12                                      (1UL)           // Specifies the ADC_D version of the ADC12 peripheral.
#define BSP_FEATURE_ADC_D_SCAN_MODE_CHANNELS_MASK                       (0xFFUL)        // Mask of channels available in scan mode.

#define BSP_FEATURE_AGT_IS_AVAILABLE                                    (0UL)
#define BSP_FEATURE_AGT_AGT_CHANNEL_COUNT                               (0U)            // Feature not available on this device.
#define BSP_FEATURE_AGT_AGTW_CHANNEL_COUNT                              (0U)            // Feature not available on this device.
#define BSP_FEATURE_AGT_USE_AGTIOSEL_ALT                                (0UL)           // Feature not available on this device.
#define BSP_FEATURE_AGT_VALID_CHANNEL_MASK                              (0x00UL)        // Feature not available on this device.
...
#define BSP_FEATURE_BSP_HAS_FSXP_CLOCK                                  (1UL)           // Indicates FSXP (subsystem clock) is available.
...
#define BSP_FEATURE_BSP_PART_NUMBER_POINTER                             (0x01011080UL)  // Address of the Part Numbering register (PNR).
...
#define BSP_FEATURE_BSP_UNIQUE_ID_POINTER                               (0x01011070UL)  // Address of the MCU Unique ID register (UIDR).
...
#define BSP_FEATURE_CANFD_HAS_CLOCK                                     (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_CGC_HAS_PCLKB                                       (0UL)           // Peripheral module clock B is available.
#define BSP_FEATURE_CGC_HAS_PCLKC                                       (0UL)           // Peripheral module clock C is available.
#define BSP_FEATURE_CGC_HAS_PCLKD                                       (0UL)           // Peripheral module clock D is available.
...
#define BSP_FEATURE_CGC_ICLK_DIV_RESET                                  (BSP_CLOCKS_SYS_CLOCK_DIV_8)    // Reset value of the ICLK divider.
...
#define BSP_FEATURE_CGC_LOW_SPEED_SUPPORT_MAIN_OSC                      (0UL)           // The main clock oscillator is available in low-speed mode.
...
#define BSP_FEATURE_CGC_MODRV_MASK                                      (R_SYSTEM_CMC_MODRV_Msk | CGC_MAINCLOCK_DRIVE_RESERVED_MASK)    // Mask used on MODRV register.
#define BSP_FEATURE_CGC_MODRV_SHIFT                                     (R_SYSTEM_CMC_MODRV_Pos)    // Shift used for MODRV register.
...
#define BSP_FEATURE_CGC_REGISTER_SET_B                                  (1UL)           // Clock generation uses an alternative register set.
...
#define BSP_FEATURE_CGC_SODRV_MASK                                      (0x06UL)        // Sub-clock drive field mask.
...
#define BSP_FEATURE_CGC_STARTUP_SCKSCR                                  (0x00UL)        // Reset value for the SCKSCR register.

#define BSP_FEATURE_CRC_IS_AVAILABLE                                    (1UL)
#define BSP_FEATURE_CRC_HAS_CRCCR0_LMS                                  (0UL)           // The CRC peripheral supports both LSB- and MSB-first calculations.
#define BSP_FEATURE_CRC_HAS_SNOOP                                       (0UL)           // The CRC peripheral can snoop on (monitor a) SCI data register for data to checksum.
#define BSP_FEATURE_CRC_POLYNOMIAL_MASK                                 (0x18U)         // Mask of available CRC polynomials; should match the mask of indexes relating to r_crc_api.h::crc_polynomial_t.
...
#define BSP_FEATURE_CTSU_CORRECTION_TYPE                                (0UL)           // CTSU correction algorithm type.
...
#define BSP_FEATURE_CTSU_SUCLK_LV_MAX_MHZ                               (30UL)          // Maximum SUCLK frequency (MHz) in low-voltage operating mode.
#define BSP_FEATURE_CTSU_SUCLK_MAX_MHZ                                  (30UL)          // Maximum SUCLK frequency (MHz) in normal voltage operating mode.
#define BSP_FEATURE_CTSU_VERSION                                        (2UL)           // Version of the CTSU peripheral.
...
#define BSP_FEATURE_DOC_IS_AVAILABLE                                    (0UL)
#define BSP_FEATURE_DOC_VERSION                                         (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_ESWM_HAS_CLOCK                                      (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_ESWM_PSFP_METER_FILTER_DOUBLE_BUCKET_METERS_MAX_NUM (0UL)           // Feature not available on this device.
#define BSP_FEATURE_ESWM_PSFP_METER_FILTER_SINGLE_BUCKET_METERS_MAX_NUM (0UL)           // Feature not available on this device.
#define BSP_FEATURE_ESWM_PSFP_MSDU_FILTER_MAX_NUM                       (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_ETHER_NUM_CHANNELS                                  (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_FLASH_CODE_CACHE_VERSION                            (0UL)           // Version of C-Cache implemented in a CM33 core.
...
#define BSP_FEATURE_FLASH_LP_DF_BLOCK_SIZE                              (0x0100UL)      // Block size of data flash.
...
#define BSP_FEATURE_GPT_IS_AVAILABLE                                    (0UL)
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                              (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_GPT_AD_CONVERSION_START_CHANNEL_MASK                (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_GPT_AD_DIRECT_START_SUPPORTED                       (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_CLOCK_DIVIDER_STEP_SIZE                         (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_CLOCK_DIVIDER_VALUE_7_9_VALID                   (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK                        (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_GPT_EVENT_COUNT_SUPPORTED                           (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_GPTE_CHANNEL_MASK                               (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_GPT_GPTE_SUPPORTED                                  (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_GPTEH_CHANNEL_MASK                              (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_GPT_GPTEH_SUPPORTED                                 (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK                              (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_GPT_GTDVU_SUPPORTED                                 (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_MSTP_HAS_MSTPCRE                                (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_MSTP_MSTPD5                                     (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_MSTP_MSTPD5_MAX_CH                              (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_ODC_128_RESOLUTION_CHANNEL_MASK                 (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_GPT_ODC_128_RESOLUTION_SUPPORTED                    (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_ODC_FRANGE_FREQ_MIN                             (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_ODC_FRANGE_SET_BIT(gpt_frequency)               (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_ODC_FREQ_MAX                                    (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_ODC_FREQ_MIN                                    (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_OPS_CHANNEL_MASK                                (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_GPT_OPS_SUPPORTED                                   (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_POLARITY_CONTROL_SUPPORTED                      (0UL)           // Feature not available on this device.
#define BSP_FEATURE_GPT_TPCS_SHIFT                                      (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_ICU_HAS_FILTER                                      (0UL)           // ICU contains digital input filtering.
#define BSP_FEATURE_ICU_HAS_IELSR                                       (0UL)           // ICU Event Link is available.
...
#define BSP_FEATURE_ICU_NMIER_MAX_INDEX                                 (8UL)           // Maximum bit field index of valid fields of the NMIER register.
#define BSP_FEATURE_ICU_SBYEDCR_MASK                                    (0x00013F838C1407FFULL) // A mask of valid bits for [SBYEDCR1:SBYEDCR0].
#define BSP_FEATURE_ICU_WUPEN_MASK                                      (0x00ULL)       // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_IIC_FAST_MODE_PLUS_CHANNELS_MASK                    (0UL)           // Mask of channels which support "Fast Mode Plus": up to 1 Mbps bit rates.
...
#define BSP_FEATURE_IOPORT_CCD_PINS_MASK                                (0xFFUL)        // Mask of valid indices for CCD pins.
#define BSP_FEATURE_IOPORT_ELC_PORTS_MASK                               (0x06UL)        // Mask of valid indices for ELC signal mapping of port input data.
#define BSP_FEATURE_IOPORT_HAS_LVOCR                                    (0UL)           // The LVOCR register is available.
#define BSP_FEATURE_IOPORT_VERSION                                      (3UL)           // Version of the system PFS block.
...
#define BSP_FEATURE_LCD_HAS_CLOCK                                       (0UL)           // Indicates there is a separate clock for the LCD.
...
#define BSP_FEATURE_LPM_HAS_DPSBYCR_DCSSMODE                            (0UL)           // The DPSBYCR.DCSSMODE field is available.
...
#define BSP_FEATURE_LPM_HAS_FLASH_MODE_SELECT                           (1UL)           // The SBYCR.FLSTP field is available.
#define BSP_FEATURE_LPM_HAS_HOCO_STARTUP_SPEED_MODE                     (1UL)           // The SBYCR.FWKUP field is available.
...
#define BSP_FEATURE_LPM_HAS_STANDBY_SOSC_SELECT                         (1UL)           // The SBYCR.RTCLPC field is available.
...
#define BSP_FEATURE_LPM_STANDBY_MODE_CLEAR_DTCST                        (1UL)           // DTCST register must be cleared prior to entering standby mode.
...
#define BSP_FEATURE_LVD_MONITOR_1_HI_THRESHOLD                          (LVD_THRESHOLD_MONITOR_1_LEVEL_4_08V)   // Typical higher bound of the detection threshold for LVD1.
#define BSP_FEATURE_LVD_MONITOR_1_LOW_THRESHOLD                         (LVD_THRESHOLD_MONITOR_1_LEVEL_1_63V)   // Typical lower bound of the detection threshold for LVD1.
#define BSP_FEATURE_LVD_MONITOR_1_STABILIZATION_TIME_US                 (1500UL)        // Maximum stabilization time to wait after LVD1 is enabled.
#define BSP_FEATURE_LVD_MONITOR_2_HI_THRESHOLD                          (LVD_THRESHOLD_NOT_AVAILABLE)   // Typical higher bound of the detection threshold for LVD2.
#define BSP_FEATURE_LVD_MONITOR_2_LOW_THRESHOLD                         (LVD_THRESHOLD_NOT_AVAILABLE)   // Typical lower bound of the detection threshold for LVD2.
#define BSP_FEATURE_LVD_MONITOR_2_STABILIZATION_TIME_US                 (0UL)           // Maximum stabilization time to wait after LVD2 is enabled.
#define BSP_FEATURE_LVD_MONITOR_MASK                                    (0x01UL)        // Mask of programmable monitors.
...
#define BSP_FEATURE_LVD_VERSION                                         (2UL)           // Version of the LVD peripheral.
...
#define BSP_FEATURE_OSPI_HAS_CLOCK                                      (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_POEG_CHANNEL_MASK                                   (0x00UL)        // Mask of valid channels for POEG.
...
#define BSP_FEATURE_RTC_HAS_VBTICTLR                                    (0UL)           // System supports VBATT input control to the RTC.
...
#define BSP_FEATURE_SAU_IS_AVAILABLE                                    (1UL)
#define BSP_FEATURE_SAU_UART_VALID_CHANNEL_MASK                         (0x07UL)        // Mask of valid channels for UART usage of the SAU peripheral.

#define BSP_FEATURE_SCI_IS_AVAILABLE                                    (0UL)
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK                     (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_SCI_CHANNELS_MASK                                   (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_SCI_CLOCK                                           (FSP_PRIV_CLOCK_UNUSED) // Feature not available on this device.
#define BSP_FEATURE_SCI_HAS_CLOCK                                       (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SCI_HAS_SCISPI_CLOCK                                (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SCI_IRDA_CHANNEL_MASK                               (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_SCI_IRDA_SUPPORTED                                  (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SCI_LIN_CHANNELS_MASK                               (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_SCI_SPI_SCKSEL_MASK                                 (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SCI_UART_ABCSE_RESTRICTED_CHANNELS_MASK             (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS_MASK                       (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_SCI_UART_DE_IS_INVERTED                             (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS_MASK                         (0x00UL)        // Feature not available on this device.
#define BSP_FEATURE_SCI_UART_FIFO_DEPTH                                 (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SCI_VERSION                                         (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_SPI_IS_AVAILABLE                                    (0UL)
#define BSP_FEATURE_SPI_BURST_TRANSFER_WITHOUT_DELAY_SUPPORTED          (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SPI_CLOCK                                           (FSP_PRIV_CLOCK_UNUSED) // Feature not available on this device.
#define BSP_FEATURE_SPI_HAS_CLOCK                                       (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SPI_HAS_SPCR3                                       (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SPI_HAS_SSL_LEVEL_KEEP                              (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SPI_NUM_CHANNELS                                    (0UL)           // Feature not available on this device.
#define BSP_FEATURE_SPI_SSL_LEVEL_KEEP_VALID_CHANNEL_MASK               (0x00UL)        // Feature not available on this device.
...
#define BSP_FEATURE_SYSC_CLOCK_FREQ_FIVE_ROM_WAITS                      (0UL)           // Maximum frequency allowed before requiring five wait cycles.
#define BSP_FEATURE_SYSC_CLOCK_FREQ_FOUR_ROM_WAITS                      (0UL)           // The maximum frequency allowed without having four ROM wait cycles.
#define BSP_FEATURE_SYSC_CLOCK_FREQ_NO_RAM_WAITS                        (0UL)           // The maximum frequency that can be used before wait cycles are necessary.
#define BSP_FEATURE_SYSC_CLOCK_FREQ_ONE_ROM_WAITS                       (0UL)           // Maximum frequency allowed before requiring one wait cycle.
#define BSP_FEATURE_SYSC_CLOCK_FREQ_THREE_ROM_WAITS                     (0UL)           // Maximum frequency allowed before requiring three wait cycles.
#define BSP_FEATURE_SYSC_CLOCK_FREQ_TWO_ROM_WAITS                       (0UL)           // Maximum frequency allowed before requiring two wait cycles.

#define BSP_FEATURE_TAU_IS_AVAILABLE                                    (1UL)
#define BSP_FEATURE_TAU_VALID_CHANNEL_MASK                              (0xFFUL)        // Mask of valid TAU channels.

#define BSP_FEATURE_TFU_IS_AVAILABLE                                    (0UL)
#define BSP_FEATURE_TFU_SUPPORTED                                       (0UL)           // Feature not available on this device.

#define BSP_FEATURE_TML_IS_AVAILABLE                                    (1UL)
#define BSP_FEATURE_TML_MAX_CLOCK_DIVIDER                               (TIMER_SOURCE_DIV_128)  // Maximum clock divider supported by TML.
#define BSP_FEATURE_TML_NUM_CHANNELS                                    (4UL)           // Number of channels available for the TML.
#define BSP_FEATURE_TML_VALID_CHANNEL_MASK                              (0x0FUL)        // Mask of valid TML channels.
...
#define BSP_FEATURE_TSN_CALIBRATION_AVAILABLE                           (0UL)           // Determine if the temperature sensor supports calibration, either factory or runtime.
...
#define BSP_FEATURE_TZ_HAS_TZFSAR                                       (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_UARTA_IS_AVAILABLE                                  (1UL)
#define BSP_FEATURE_UARTA_HAS_CLOCK_OUTPUT                              (0UL)           // CLKAn can be output from the device.
#define BSP_FEATURE_UARTA_MSTP_OFFSET                                   (15UL)          // Offset for the UARTA MSTP bit.
#define BSP_FEATURE_UARTA_PCLK_RESTRICTION                              (0UL)           // The peripheral clock for UARTA must be >= the UARTn operating clock.

#define BSP_FEATURE_ULPT_IS_AVAILABLE                                   (0UL)
#define BSP_FEATURE_ULPT_NUM_CHANNELS_AVAILABLE                         (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_USB_HAS_CLOCK_REQ                                   (0UL)           // Feature not available on this device.
#define BSP_FEATURE_USB_HAS_CLOCK_SEL                                   (0UL)           // Feature not available on this device.
#define BSP_FEATURE_USB_HAS_CLOCK_SEL_ALT                               (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_USB_HAS_USB60_CLOCK                                 (0UL)           // Feature not available on this device.
#define BSP_FEATURE_USB_HAS_USBCKDIVCR                                  (0UL)           // Feature not available on this device.
