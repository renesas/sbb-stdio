...
/** @} */ /* End of group Configuration_of_CMSIS */
 ...
 #include "system.h"                       /*!< R7FA0L107 System                                                          */
...
typedef struct                         /*!< (@ 0x400A1800) R_ADC_D Structure                                          */
{
    ...
    __IM uint16_t RESERVED2[6];

    union
    {
        __IM uint16_t ADCR[4];         /*!< (@ 0x00000120) A/D Conversion Result Register                             */

        struct
        {
            uint16_t            : 8;
            __IM uint16_t ADCRH : 8;   /*!< [15..8] 8-bit A/D Conversion Result Register                              */
        } ADCR_b[4];
    };
...
typedef struct                         /*!< (@ 0x40081000) R_CTSU2 Structure                                          */
{
    union
    {
        union
    ...
    union
    {
        ...
        struct
        {
            ...
            union
            {
                __IM uint16_t CTSUUC;           /*!< (@ 0x00000026) CTSU Sensor Counter Register                               */

                struct
                {
                    __IM uint16_t SENSCNT : 16; /*!< [15..0] CTSU Sensor Counter                                               */
                } CTSUUC_b;
            };
        };
    };
...
typedef struct                         /*!< (@ 0x407EBE6C) R_CTSUTRIM Structure                                       */
{
...
/**
 * @brief Serial Interface IICA0 (R_IICA0)
 */

typedef struct                         /*!< (@ 0x400A3000) R_IICA0 Structure                                          */
{
...
/**
 * @brief 32-bit Interval Timer (R_TML)
 */

typedef struct                         /*!< (@ 0x400A3800) R_TML Structure                                            */
{
    union
    {
 ...
 */
 ...
 #define R_CTSU2_BASE       0x40081000UL
 ...
 #define R_CTSUTRIM_BASE    0x407EBE6CUL
 ...
 #define R_UARTA1_BASE      0x400A3408UL
 ...
 */
 ...
 #define R_UARTA1      ((R_UARTA0_Type *) R_UARTA1_BASE)
...
/* =========================================================  ADCR  ========================================================== */
 #define R_ADC_D_ADCR_ADCRH_Pos     (8UL)      /*!< ADCRH (Bit 8)                                         */
 #define R_ADC_D_ADCR_ADCRH_Msk     (0xff00UL) /*!< ADCRH (Bitfield-Mask: 0xff)                           */
...
/* =======================================================  CTSUAJRR1  ======================================================= */
/* ========================================================  CTSUUC  ========================================================= */
 #define R_CTSU2_CTSUUC_SENSCNT_Pos             (0UL)      /*!< SENSCNT (Bit 0)                                       */
 #define R_CTSU2_CTSUUC_SENSCNT_Msk             (0xffffUL) /*!< SENSCNT (Bitfield-Mask: 0xffff)                       */
...
/* =========================================================  IICA0  ========================================================= */
/* =========================================================  IICS0  ========================================================= */
 #define R_IICA0_IICS0_SPD_Pos          (0UL)    /*!< SPD (Bit 0)                                           */
 #define R_IICA0_IICS0_SPD_Msk          (0x1UL)  /*!< SPD (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICS0_STD_Pos          (1UL)    /*!< STD (Bit 1)                                           */
 #define R_IICA0_IICS0_STD_Msk          (0x2UL)  /*!< STD (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICS0_ACKD_Pos         (2UL)    /*!< ACKD (Bit 2)                                          */
 #define R_IICA0_IICS0_ACKD_Msk         (0x4UL)  /*!< ACKD (Bitfield-Mask: 0x01)                            */
 #define R_IICA0_IICS0_TRC_Pos          (3UL)    /*!< TRC (Bit 3)                                           */
 #define R_IICA0_IICS0_TRC_Msk          (0x8UL)  /*!< TRC (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICS0_COI_Pos          (4UL)    /*!< COI (Bit 4)                                           */
 #define R_IICA0_IICS0_COI_Msk          (0x10UL) /*!< COI (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICS0_EXC_Pos          (5UL)    /*!< EXC (Bit 5)                                           */
 #define R_IICA0_IICS0_EXC_Msk          (0x20UL) /*!< EXC (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICS0_ALD_Pos          (6UL)    /*!< ALD (Bit 6)                                           */
 #define R_IICA0_IICS0_ALD_Msk          (0x40UL) /*!< ALD (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICS0_MSTS_Pos         (7UL)    /*!< MSTS (Bit 7)                                          */
 #define R_IICA0_IICS0_MSTS_Msk         (0x80UL) /*!< MSTS (Bitfield-Mask: 0x01)                            */
/* =========================================================  IICF0  ========================================================= */
 #define R_IICA0_IICF0_IICRSV_Pos       (0UL)    /*!< IICRSV (Bit 0)                                        */
 #define R_IICA0_IICF0_IICRSV_Msk       (0x1UL)  /*!< IICRSV (Bitfield-Mask: 0x01)                          */
 #define R_IICA0_IICF0_STCEN_Pos        (1UL)    /*!< STCEN (Bit 1)                                         */
 #define R_IICA0_IICF0_STCEN_Msk        (0x2UL)  /*!< STCEN (Bitfield-Mask: 0x01)                           */
 #define R_IICA0_IICF0_IICBSY_Pos       (6UL)    /*!< IICBSY (Bit 6)                                        */
 #define R_IICA0_IICF0_IICBSY_Msk       (0x40UL) /*!< IICBSY (Bitfield-Mask: 0x01)                          */
 #define R_IICA0_IICF0_STCF_Pos         (7UL)    /*!< STCF (Bit 7)                                          */
 #define R_IICA0_IICF0_STCF_Msk         (0x80UL) /*!< STCF (Bitfield-Mask: 0x01)                            */
/* =======================================================  IICCTL00  ======================================================== */
 #define R_IICA0_IICCTL00_SPT_Pos       (0UL)    /*!< SPT (Bit 0)                                           */
 #define R_IICA0_IICCTL00_SPT_Msk       (0x1UL)  /*!< SPT (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICCTL00_STT_Pos       (1UL)    /*!< STT (Bit 1)                                           */
 #define R_IICA0_IICCTL00_STT_Msk       (0x2UL)  /*!< STT (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICCTL00_ACKE_Pos      (2UL)    /*!< ACKE (Bit 2)                                          */
 #define R_IICA0_IICCTL00_ACKE_Msk      (0x4UL)  /*!< ACKE (Bitfield-Mask: 0x01)                            */
 #define R_IICA0_IICCTL00_WTIM_Pos      (3UL)    /*!< WTIM (Bit 3)                                          */
 #define R_IICA0_IICCTL00_WTIM_Msk      (0x8UL)  /*!< WTIM (Bitfield-Mask: 0x01)                            */
 #define R_IICA0_IICCTL00_SPIE_Pos      (4UL)    /*!< SPIE (Bit 4)                                          */
 #define R_IICA0_IICCTL00_SPIE_Msk      (0x10UL) /*!< SPIE (Bitfield-Mask: 0x01)                            */
 #define R_IICA0_IICCTL00_WREL_Pos      (5UL)    /*!< WREL (Bit 5)                                          */
 #define R_IICA0_IICCTL00_WREL_Msk      (0x20UL) /*!< WREL (Bitfield-Mask: 0x01)                            */
 #define R_IICA0_IICCTL00_LREL_Pos      (6UL)    /*!< LREL (Bit 6)                                          */
 #define R_IICA0_IICCTL00_LREL_Msk      (0x40UL) /*!< LREL (Bitfield-Mask: 0x01)                            */
 #define R_IICA0_IICCTL00_IICE_Pos      (7UL)    /*!< IICE (Bit 7)                                          */
 #define R_IICA0_IICCTL00_IICE_Msk      (0x80UL) /*!< IICE (Bitfield-Mask: 0x01)                            */
/* =======================================================  IICCTL01  ======================================================== */
 #define R_IICA0_IICCTL01_PRS_Pos       (0UL)    /*!< PRS (Bit 0)                                           */
 #define R_IICA0_IICCTL01_PRS_Msk       (0x1UL)  /*!< PRS (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICCTL01_DFC_Pos       (2UL)    /*!< DFC (Bit 2)                                           */
 #define R_IICA0_IICCTL01_DFC_Msk       (0x4UL)  /*!< DFC (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICCTL01_SMC_Pos       (3UL)    /*!< SMC (Bit 3)                                           */
 #define R_IICA0_IICCTL01_SMC_Msk       (0x8UL)  /*!< SMC (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICCTL01_DAD_Pos       (4UL)    /*!< DAD (Bit 4)                                           */
 #define R_IICA0_IICCTL01_DAD_Msk       (0x10UL) /*!< DAD (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICCTL01_CLD_Pos       (5UL)    /*!< CLD (Bit 5)                                           */
 #define R_IICA0_IICCTL01_CLD_Msk       (0x20UL) /*!< CLD (Bitfield-Mask: 0x01)                             */
 #define R_IICA0_IICCTL01_SVADIS_Pos    (6UL)    /*!< SVADIS (Bit 6)                                        */
 #define R_IICA0_IICCTL01_SVADIS_Msk    (0x40UL) /*!< SVADIS (Bitfield-Mask: 0x01)                          */
 #define R_IICA0_IICCTL01_WUP_Pos       (7UL)    /*!< WUP (Bit 7)                                           */
 #define R_IICA0_IICCTL01_WUP_Msk       (0x80UL) /*!< WUP (Bitfield-Mask: 0x01)                             */
/* ========================================================  IICWL0  ========================================================= */
/* ========================================================  IICWH0  ========================================================= */
/* =========================================================  SVA0  ========================================================== */
 #define R_IICA0_SVA0_A_Pos             (1UL)    /*!< A (Bit 1)                                             */
 #define R_IICA0_SVA0_A_Msk             (0xfeUL) /*!< A (Bitfield-Mask: 0x7f)                               */
...
/* =======================================================  ITLCAP00  ======================================================== */
/* ========================================================  ITLCTL0  ======================================================== */
 #define R_TML_ITLCTL0_EN0_Pos        (0UL)    /*!< EN0 (Bit 0)                                           */
 #define R_TML_ITLCTL0_EN0_Msk        (0x1UL)  /*!< EN0 (Bitfield-Mask: 0x01)                             */
 #define R_TML_ITLCTL0_EN1_Pos        (1UL)    /*!< EN1 (Bit 1)                                           */
 #define R_TML_ITLCTL0_EN1_Msk        (0x2UL)  /*!< EN1 (Bitfield-Mask: 0x01)                             */
 #define R_TML_ITLCTL0_EN2_Pos        (2UL)    /*!< EN2 (Bit 2)                                           */
 #define R_TML_ITLCTL0_EN2_Msk        (0x4UL)  /*!< EN2 (Bitfield-Mask: 0x01)                             */
 #define R_TML_ITLCTL0_EN3_Pos        (3UL)    /*!< EN3 (Bit 3)                                           */
 #define R_TML_ITLCTL0_EN3_Msk        (0x8UL)  /*!< EN3 (Bitfield-Mask: 0x01)                             */
 #define R_TML_ITLCTL0_MD_Pos         (6UL)    /*!< MD (Bit 6)                                            */
 #define R_TML_ITLCTL0_MD_Msk         (0xc0UL) /*!< MD (Bitfield-Mask: 0x03)                              */
/* =======================================================  ITLCSEL0  ======================================================== */
 #define R_TML_ITLCSEL0_ISEL_Pos      (0UL)    /*!< ISEL (Bit 0)                                          */
 #define R_TML_ITLCSEL0_ISEL_Msk      (0x7UL)  /*!< ISEL (Bitfield-Mask: 0x07)                            */
 #define R_TML_ITLCSEL0_CSEL_Pos      (4UL)    /*!< CSEL (Bit 4)                                          */
 #define R_TML_ITLCSEL0_CSEL_Msk      (0x70UL) /*!< CSEL (Bitfield-Mask: 0x07)                            */
/* =======================================================  ITLFDIV00  ======================================================= */
 #define R_TML_ITLFDIV00_FDIV0_Pos    (0UL)    /*!< FDIV0 (Bit 0)                                         */
 #define R_TML_ITLFDIV00_FDIV0_Msk    (0x7UL)  /*!< FDIV0 (Bitfield-Mask: 0x07)                           */
 #define R_TML_ITLFDIV00_FDIV1_Pos    (4UL)    /*!< FDIV1 (Bit 4)                                         */
 #define R_TML_ITLFDIV00_FDIV1_Msk    (0x70UL) /*!< FDIV1 (Bitfield-Mask: 0x07)                           */
/* =======================================================  ITLFDIV01  ======================================================= */
 #define R_TML_ITLFDIV01_FDIV2_Pos    (0UL)    /*!< FDIV2 (Bit 0)                                         */
 #define R_TML_ITLFDIV01_FDIV2_Msk    (0x7UL)  /*!< FDIV2 (Bitfield-Mask: 0x07)                           */
 #define R_TML_ITLFDIV01_FDIV3_Pos    (4UL)    /*!< FDIV3 (Bit 4)                                         */
 #define R_TML_ITLFDIV01_FDIV3_Msk    (0x70UL) /*!< FDIV3 (Bitfield-Mask: 0x07)                           */
/* ========================================================  ITLCC0  ========================================================= */
 #define R_TML_ITLCC0_CTRS_Pos        (0UL)    /*!< CTRS (Bit 0)                                          */
 #define R_TML_ITLCC0_CTRS_Msk        (0x3UL)  /*!< CTRS (Bitfield-Mask: 0x03)                            */
 #define R_TML_ITLCC0_CAPCCR_Pos      (3UL)    /*!< CAPCCR (Bit 3)                                        */
 #define R_TML_ITLCC0_CAPCCR_Msk      (0x8UL)  /*!< CAPCCR (Bitfield-Mask: 0x01)                          */
 #define R_TML_ITLCC0_CAPR_Pos        (4UL)    /*!< CAPR (Bit 4)                                          */
 #define R_TML_ITLCC0_CAPR_Msk        (0x10UL) /*!< CAPR (Bitfield-Mask: 0x01)                            */
 #define R_TML_ITLCC0_CAPF_Pos        (5UL)    /*!< CAPF (Bit 5)                                          */
 #define R_TML_ITLCC0_CAPF_Msk        (0x20UL) /*!< CAPF (Bitfield-Mask: 0x01)                            */
 #define R_TML_ITLCC0_CAPFCR_Pos      (6UL)    /*!< CAPFCR (Bit 6)                                        */
 #define R_TML_ITLCC0_CAPFCR_Msk      (0x40UL) /*!< CAPFCR (Bitfield-Mask: 0x01)                          */
 #define R_TML_ITLCC0_CAPEN_Pos       (7UL)    /*!< CAPEN (Bit 7)                                         */
 #define R_TML_ITLCC0_CAPEN_Msk       (0x80UL) /*!< CAPEN (Bitfield-Mask: 0x01)                           */
/* =========================================================  ITLS0  ========================================================= */
 #define R_TML_ITLS0_ITF00_Pos        (0UL)    /*!< ITF00 (Bit 0)                                         */
 #define R_TML_ITLS0_ITF00_Msk        (0x1UL)  /*!< ITF00 (Bitfield-Mask: 0x01)                           */
 #define R_TML_ITLS0_ITF01_Pos        (1UL)    /*!< ITF01 (Bit 1)                                         */
 #define R_TML_ITLS0_ITF01_Msk        (0x2UL)  /*!< ITF01 (Bitfield-Mask: 0x01)                           */
 #define R_TML_ITLS0_ITF02_Pos        (2UL)    /*!< ITF02 (Bit 2)                                         */
 #define R_TML_ITLS0_ITF02_Msk        (0x4UL)  /*!< ITF02 (Bitfield-Mask: 0x01)                           */
 #define R_TML_ITLS0_ITF03_Pos        (3UL)    /*!< ITF03 (Bit 3)                                         */
 #define R_TML_ITLS0_ITF03_Msk        (0x8UL)  /*!< ITF03 (Bitfield-Mask: 0x01)                           */
 #define R_TML_ITLS0_ITF0C_Pos        (4UL)    /*!< ITF0C (Bit 4)                                         */
 #define R_TML_ITLS0_ITF0C_Msk        (0x10UL) /*!< ITF0C (Bitfield-Mask: 0x01)                           */
/* ========================================================  ITLMKF0  ======================================================== */
 #define R_TML_ITLMKF0_MKF00_Pos      (0UL)    /*!< MKF00 (Bit 0)                                         */
 #define R_TML_ITLMKF0_MKF00_Msk      (0x1UL)  /*!< MKF00 (Bitfield-Mask: 0x01)                           */
 #define R_TML_ITLMKF0_MKF01_Pos      (1UL)    /*!< MKF01 (Bit 1)                                         */
 #define R_TML_ITLMKF0_MKF01_Msk      (0x2UL)  /*!< MKF01 (Bitfield-Mask: 0x01)                           */
 #define R_TML_ITLMKF0_MKF02_Pos      (2UL)    /*!< MKF02 (Bit 2)                                         */
 #define R_TML_ITLMKF0_MKF02_Msk      (0x4UL)  /*!< MKF02 (Bitfield-Mask: 0x01)                           */
 #define R_TML_ITLMKF0_MKF03_Pos      (3UL)    /*!< MKF03 (Bit 3)                                         */
 #define R_TML_ITLMKF0_MKF03_Msk      (0x8UL)  /*!< MKF03 (Bitfield-Mask: 0x01)                           */
 #define R_TML_ITLMKF0_MKF0C_Pos      (4UL)    /*!< MKF0C (Bit 4)                                         */
 #define R_TML_ITLMKF0_MKF0C_Msk      (0x10UL) /*!< MKF0C (Bitfield-Mask: 0x01)                           */
