...
#define BSP_CFG_CLKOUT_SOURCE (BSP_CLOCKS_CLOCK_DISABLED) /* CLKOUT0 Disabled */
#define BSP_CFG_CLKOUT_DIV (0x0U) /* CLKOUT0 Div /1 */
#define BSP_CFG_CLKOUT1_SOURCE (BSP_CLOCKS_CLOCK_DISABLED) /* CLKOUT1 Disabled */
#define BSP_CFG_CLKOUT1_DIV (0x0U) /* CLKOUT1 Div /1 */
#define BSP_CFG_UTASEL_CLOCK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_HOCO) /* UTASEL Src: HOCO */
#define BSP_CFG_UARTA0_CLOCK_SOURCE (BSP_CFG_UTASEL_CLOCK_SOURCE) /* UARTA0 Src: UTASEL */
#define BSP_CFG_UARTA1_CLOCK_SOURCE (BSP_CFG_UTASEL_CLOCK_SOURCE) /* UARTA1 Src: UTASEL */
