...
static sci_b_uart_instance_ctrl_t g_uart_jlob_vcom_ref_ctrl;

static const sci_b_baud_setting_t g_uart_jlob_vcom_ref_baud_setting =
{
...
static const sci_b_uart_extended_cfg_t g_uart_jlob_vcom_ref_cfg_extend =
{
...
{
    extern sci_b_baud_setting_t g_uart0_baud_setting;
    ...
    rs_stdio_uart_cfg_t const rs_stdio_uart_check =
    {
         ...
         .sci_b_baud_setting = g_uart0_baud_setting,
         .sci_b_uart_extended_cfg = g_uart0_cfg_extend,
         .sci_b_uart_instance_ctrl = {0},
    };
    ...
    check.stdio_uart_cfg.uart_instance.p_ctrl = &check.stdio_uart_cfg.sci_b_uart_instance_ctrl;
